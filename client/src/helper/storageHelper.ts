 ...
 * @param {*} value
 */
export const tryAddToStorage = (storageType: string, key: string, value: any) => {
    return tryCatch(() => {
        switch (storageType) {
            case 'session':
 ...
 * @returns 
 */
export const tryRemoveFromStorage = (storageType: string, key: string) => {
    return tryCatch(() => {
        switch (storageType) {
            case 'session':
 ...
 * @returns 
 */
export const tryClearStorage = (storageType: string) => {
    return tryCatch(() => {
        switch (storageType) {
            case 'session':
